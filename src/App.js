  ...
  return (
    <div>
      ...
      <Section
        ...
        info="Step into the courtroom and put your legal skills to the test at ‘The Courting’! This thrilling event is your chance to experience the novelty and excitement of a real-world courtroom battle.

        
        
        In three rounds of intense competition, you'll be presented with a legal case brief and tasked with arguing both sides of the case. You'll need to use your knowledge of the law, your persuasive skills, and your ability to think on your feet to convince the judges that your team has the winning argument. 
      ...
      <Section
        ...
        "
      />
      <Section title="Deal or No Deal" subtitle="" info="" />
    </div>
  );
}
